...
def valorBoton(player_marker):
        player_marker.set(player_marker)

        
#--------------- primera linea de botones -----------------------

boton7 = Button(marco, text= lambda : valorBoton(player_marker), width=3, bg= "#7df5db", command = lambda: place_marker(board, player_marker, 7))
